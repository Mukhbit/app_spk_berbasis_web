...
?>
  ...
  <head>
    ...
    <title>Aplikasi SPK Menentukan Supplier Obat Terbaik Metode WP</title>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- <a href="assets/img/apotek-removebg-preview.png" class="logo">
          <span class="logo-lg"><b>Apotek Annisa Aulia</b></span>
