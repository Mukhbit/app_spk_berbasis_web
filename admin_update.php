	...
	<form class="form-horizontal" action="<?php echo $link_update; ?>" method="post">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input name="username" id="username" class="form-control" required type="text" value="<?= $username; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="username" class="col-sm-2 control-label">Full Name</label>
				<div class="col-sm-4">
					<input name="fullname" id="fullname" class="form-control" required type="text" value="<?= $fullname; ?>">
				</div>
			</div>
			<?php if ($action == "add") { ?>
				<div class="form-group">
